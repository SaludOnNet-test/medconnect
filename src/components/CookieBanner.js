 ...
 * - Reject: stores rejection, no tracking loaded
    ...
    <>
      <div style={{
        ...
        <p style={{ margin: 0, flex: 1, minWidth: '240px' }}>
          Usamos cookies propias y de terceros (Google Analytics, Microsoft Clarity) para analizar el tráfico y mejorar tu experiencia. Puedes aceptarlas o rechazarlas.{' '}
