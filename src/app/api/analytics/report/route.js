...
export async function GET(request) {
  ...
  try {
    ...
    const message = await client.messages.create({
      ...
      messages: [{
        role: 'user',
        content: `You are a UX/conversion analyst for Med Connect, a Spanish private healthcare appointment booking platform. Patients search for specialists, browse clinics on a Doctoralia-style page, select time slots, and pay a priority fee (4 € – 19 € depending on urgency: 4 € for appointments more than 30 days out, 8 € between 15 and 30 days, 15 € between 7 and 14 days, 19 € for appointments within 7 days).
